...
// id 30
template <typename ALayout,         // Row
          typename BLayout,         // Col
          typename DsLayout,        // <Row, Col>
          typename CLayout,         // Row
          typename ADataType,       // FP8
          typename BDataType,       // FP8
          typename AccDataType,     // FP32
          typename CShuffleDataType,    // FP32
          typename DsDataType,      // <FP32, FP32>
          typename CDataType,       // FP16
          typename AElementwiseOperation,       // PassThrough
          typename BElementwiseOperation,       // PassThrough
          typename CElementwiseOperation,       // MultiplyMultiply
          tensor_operation::device::GemmSpecialization GemmSpec,
          index_t BlockSize,    // 256
          index_t MPerBlock,    // 16
          index_t NPerBlock,    // 128
          index_t KPerBlock,    // 512
          index_t AK1Value,     // 16
          index_t BK1Value,     // 16
          index_t MPerXdl,      // 16
          index_t NPerXdl,      // 16
          index_t MXdlPerWave,  // 1
          index_t NXdlPerWave,  // 2
          typename ABlockTransferThreadClusterLengths_AK0_M_AK1,    // 32, 8, 1
          typename ABlockTransferThreadClusterArrangeOrder,         // 1, 0, 2
          typename ABlockTransferSrcAccessOrder,                    // 1, 0, 2
          index_t ABlockTransferSrcVectorDim,                       // 2
          index_t ABlockTransferSrcScalarPerVector,                 // 16
          index_t ABlockTransferDstScalarPerVector_AK1,             // 16
          bool AThreadTransferSrcResetCoordinateAfterRun,           // False
          index_t ABlockLdsExtraM,                                  // 0 or False
          typename BBlockTransferThreadClusterLengths_BK0_N_BK1,    // 32, 8, 1
          typename BBlockTransferThreadClusterArrangeOrder,         // 1, 0, 2
          typename BBlockTransferSrcAccessOrder,                    // 1, 0, 2
          index_t BBlockTransferSrcVectorDim,                       // 2
          index_t BBlockTransferSrcScalarPerVector,                 // 16
          index_t BBlockTransferDstScalarPerVector_BK1,             // 16
          bool BThreadTransferSrcResetCoordinateAfterRun,           // False
          index_t BBlockLdsExtraN,                                  // 0 or False
          index_t CShuffleMXdlPerWavePerShuffle,                    // 1
          index_t CShuffleNXdlPerWavePerShuffle,                    // 1
          typename CShuffleBlockTransferClusterLengths_MBlock_MPerBlock_NBlock_NPerBlock, // 1, 16, 1, 16
          typename CDEShuffleBlockTransferScalarPerVectors,         // 4, 4, 1
...
struct GridwiseGemmMultiD_xdl_cshuffle_v3_b_preshuffle
{
    ...
    static constexpr auto CShuffleBlockTransferScalarPerVector_NPerBlock = // 4
        CDEShuffleBlockTransferScalarPerVectors{}[I0]; // 4, 4, 1
    // K1 should be Number<...>
    static constexpr auto AK0Number       = Number<KPerBlock / AK1Value>{};  // 512 / 16 = 32
    static constexpr auto BK0Number       = Number<KPerBlock / BK1Value>{};  // 512 / 16 = 32
    static constexpr auto AK1Number       = Number<AK1Value>{};              // 16
    static constexpr auto BK1Number       = Number<BK1Value>{};              // 16
    static constexpr auto BlockSizeNumber = Number<BlockSize>{};             // 256

    static constexpr index_t NumDTensor = DsDataType::Size(); // 2
    ...
    static constexpr index_t KLane =
        ...
        // num_input_blks * k_per_blk / k_per_blk
        // 4 * 8 / 8
        // 4
    static constexpr index_t KRepeat = KPerBlock / KLane / KPack; // 512 / 4 / 256 = 0.5
    static constexpr index_t NLane   = NPerXdl;  // 16
    static constexpr index_t NWave   = NPerBlock / NPerXdl / NXdlPerWave; // 128 / 16 / 2 = 4
    static_assert(NWave * warpSize == BlockSize); // 4 * 64 == 256
